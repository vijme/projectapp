...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { email: @register.email, hospitalID: @register.hospitalID, name: @register.name, password: @register.password }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { email: @register.email, hospitalID: @register.hospitalID, name: @register.name, password: @register.password }
    assert_redirected_to register_path(assigns(:register))
  end
